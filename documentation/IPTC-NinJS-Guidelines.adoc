...
*Associations* are a means of linking news items together.
...
|`expectedDuration`
a|The time period that the event or coverage is expected to last. (Actual duration can be calculated from startDate and endDate)
|string

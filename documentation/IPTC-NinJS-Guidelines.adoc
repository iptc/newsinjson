...
:revnumber: 3.1, 2.2 and 1.6
:revremark: Revised 2025-06-16
:toc: left
...
The latest version of the standard is 3.1. 
https://iptc.org/std/ninjs/ninjs-schema_3.1.json[Version 3.1 of the ninjs
schema] was made available in June 2025.

The latest version in the 2.x branch is 2.2, which was made available in June 2025.
See below for more information on the <<Differences between ninjs 1.x and 2.x,differences between the 1.x and 2.x branches>>.

The latest version in the 1.x branch is 1.6, which was also made available in June 2025.
See below for more information on the <<Differences between ninjs 1.x and 2.x,differences between the 1.x and 2.x branches>>.
...
[source,json]
----
include::includes/examples/3.1/001_simple_example.json[]
----
...
[source,json]
----
include::includes/examples/2.2/001_simple_example.json[]
----
...
[source,json]
----
include::includes/examples/1.6/001_simple_example.json[]
----
...
=== Versions of ninjs: ninjs 3.1, 2.2 and 1.6

IPTC manages three versions of ninjs: the 3.x branch (where the latest version
is 3.1), the 2.x branch (where the latest version is 2.2) and the 1.x branch
(where the latest version is 1.6).
...
latest release in this series is 1.6, which adds <<digitalSourceType,`digitalsourcetype`>>.
...
All new users are strongly recommended to use version 3.1.

ninjs 3.1, 2.2 and 1.6 were approved by the IPTC Standards Committee on May 16th,
2025.

This document focuses on the 3.1 version, but includes notes where the 2.x and
1.x versions differ. Those who must use version 2.x or 1.x for backwards
compatibility reasons can find the JSON Schema file for ninjs 2.2 at
https://iptc.org/std/ninjs/ninjs-schema_2.2.json and the schema file for ninjs 1.6
at https://iptc.org/std/ninjs/ninjs-schema_1.6.json.
...
version in the ninjs 3.x branch, currently ninjs 3.1.  This version should be
...
These tables primarily describe the ninjs 3.1 schema. Where possible, we note
...
!`version`
!The version of the standard used, such as `3.1`.
!string

!`schema`
!The uri of the JSON schema to use for validation, such as `https://www.iptc.org/std/ninjs/ninjs-schema_3.1.json`
!URI
...
[source,json]
----
include::includes/examples/3.1/008_event.json[]
----
...
[source,json]
----
include::includes/examples/3.1/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/2.2/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/1.6/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/3.1/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/2.2/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/1.6/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/3.1/004_simple_text_article.json[]
----
...
[source,json]
----
include::includes/examples/2.2/004_simple_text_article.json[]
----
...
[source,json]
----
include::includes/examples/1.6/004_simple_text_article.json[]
----
====
...
[source,json]
----
include::includes/examples/3.1/005_complex_text_article.json[]
----
...
[source,json]
----
include::includes/examples/2.2/005_complex_text_article.json[]
----
...
[source,json]
----
include::includes/examples/1.6/005_complex_text_article.json[]
----
====
...
[source,json]
----
include::includes/examples/3.1/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/2.2/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/1.6/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/3.1/007_multimedia.json[]
----
...
[source,json]
----
include::includes/examples/2.2/007_multimedia.json[]
----
...
[source,json]
----
include::includes/examples/1.6/007_multimedia.json[]
----
...
. change the URL of the "id" property of IPTC's ninjs 3.1 ...
+
[source,json]
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "id" : "http://www.iptc.org/std/ninjs/ninjs-schema_3.1.json#",
  "type" : "object",
  ...
+
...
https://iptc.org/std/ninjs/ninjs-schema_3.1.json
...
sample ninjs documents. It supports ninjs versions 1.6, 2.2 and 3.1, so it

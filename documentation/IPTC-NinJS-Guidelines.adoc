...
!contenttype
!The IANA (Internet Assigned Numbers Authority) media type of the content of this headline. (Used to be MIME type.) 
!string
...
!contenttype
!The IANA (Internet Assigned Numbers Authority) media type of the content of this description. (Used to be MIME type.)
!string

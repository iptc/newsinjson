...
schema] was made available in November 2024.

The latest version in the 2.x branch is 2.1, which was made avaialble in June 2023.
See below for more information on the <<Differences between ninjs 1.x and 2.x,differences between the 1.x and 2.x branches>>.

The latest version in the 1.x branch is 1.5, which was also made avaialble in June 2023.
See below for more information on the <<Differences between ninjs 1.x and 2.x,differences between the 1.x and 2.x branches>>.
...
keeping with JSON best practices, especially regarding GraphQL usage. ninjs 3.0 was
...
version in the ninjs 3.x branch, currently ninjs 3.0.  This version should be
easiest for developers to work with.

If you are already using a 1.x or 2.x version of ninjs, we recommend at least
upgrading to the latest version in that branch, currently 1.5 and 2.1. This
...
NOTE: This section applies to ninjs 3.0 only.
...
|===
|Property name +
(3.0 only)|Description|Data type
...
https://iptc.org/std/ninjs/ninjs-schema_3.0.json
...
sample ninjs documents. It supports ninjs versions 1.5, 2.1 and 3.0, so it
...
release a type for ninjs 3.0 soon.

...
:revnumber: 3.2, 2.3 and 1.7
:revremark: Revised 2025-11-05
:toc: left
...
The latest version of the standard is 3.2. 
https://iptc.org/std/ninjs/ninjs-schema_3.2.json[Version 3.2 of the ninjs
schema] was made available in November 2025.

The latest version in the 2.x branch is 2.3, which was made available in November 2025.
See below for more information on the <<Differences between ninjs 1.x and 2.x,differences between the 1.x and 2.x branches>>.

The latest version in the 1.x branch is 1.7, which was also made available in November 2025.
See below for more information on the <<Differences between ninjs 1.x and 2.x,differences between the 1.x and 2.x branches>>.
...
[source,json]
----
include::includes/examples/3.2/001_simple_example.json[]
----
...
[source,json]
----
include::includes/examples/2.3/001_simple_example.json[]
----
...
[source,json]
----
include::includes/examples/1.7/001_simple_example.json[]
----
...
=== Versions of ninjs: ninjs 3.2, 2.3 and 1.7

IPTC manages three versions of ninjs: the 3.x branch (where the latest version
is 3.2), the 2.x branch (where the latest version is 2.3) and the 1.x branch
(where the latest version is 1.7).
...
latest release in this series is 1.7, which adds <<resources>> under <<renditions>>.
...
All new users are strongly recommended to use version 3.2.

ninjs 3.2, 2.3 and 1.7 were approved by the IPTC Standards Committee on October
16th, 2025.

This document focuses on the 3.2 version, but includes notes where the 2.x and
1.x versions differ. Those who must use version 2.x or 1.x for backwards
compatibility reasons can find the JSON Schema file for ninjs 2.3 at
https://iptc.org/std/ninjs/ninjs-schema_2.3.json and the schema file for ninjs 1.7
at https://iptc.org/std/ninjs/ninjs-schema_1.7.json.
...
version in the ninjs 3.x branch, currently ninjs 3.2.  This version should be
...
These tables primarily describe the ninjs 3.2 schema. Where possible, we note
...
!`version`
!The version of the standard used, such as `3.2`.
!string

!`schema`
!The uri of the JSON schema to use for validation, such as `https://www.iptc.org/std/ninjs/ninjs-schema_3.2.json`
!URI
...
[source,json]
----
include::includes/examples/3.2/008_event.json[]
----
...
[source,json]
----
include::includes/examples/3.2/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/2.3/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/1.7/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/3.2/009_rendition_resources_example.json[]
----
...
[source,json]
----
include::includes/examples/2.3/009_rendition_resources_example.json[]
----
...
[source,json]
----
include::includes/examples/1.7/009_rendition_resources_example.json[]
----
...
[source,json]
----
include::includes/examples/3.2/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/2.3/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/1.7/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/3.2/004_simple_text_article.json[]
----
...
[source,json]
----
include::includes/examples/2.3/004_simple_text_article.json[]
----
...
[source,json]
----
include::includes/examples/1.7/004_simple_text_article.json[]
----
====
...
[source,json]
----
include::includes/examples/3.2/005_complex_text_article.json[]
----
...
[source,json]
----
include::includes/examples/2.3/005_complex_text_article.json[]
----
...
[source,json]
----
include::includes/examples/1.7/005_complex_text_article.json[]
----
====
...
[source,json]
----
include::includes/examples/3.2/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/2.3/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/1.7/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/3.2/007_multimedia.json[]
----
...
[source,json]
----
include::includes/examples/2.3/007_multimedia.json[]
----
...
[source,json]
----
include::includes/examples/1.7/007_multimedia.json[]
----
...
All three versions were updated to add a new section within <<renditions>> called <<resources>>. This allows providers to specify components within a media item, such as different audio or subtitle tracks within a video stream or video file.

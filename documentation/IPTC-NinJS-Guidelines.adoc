...
:revnumber: 3.0, 2.1 and 1.5
:revremark: Revised 2024-11-26
:toc: left
...
The latest version of the standard is 3.0. 
https://iptc.org/std/ninjs/ninjs-schema_3.0.json[Version 3.0 of the ninjs
...
[source,json]
----
include::includes/examples/3.0/001_simple_example.json[]
----
...
[source,json]
----
include::includes/examples/2.1/001_simple_example.json[]
----
...
[source,json]
----
include::includes/examples/1.5/001_simple_example.json[]
----
...
=== Versions of ninjs: ninjs 3.0, 2.1 and 1.5

IPTC manages three versions of ninjs: the 3.x branch (where the latest version
is 3.0), the 2.x branch (where the latest version is 2.1) and the 1.x branch
(where the latest version is 1.5).
...
ninjs 3.0 was approved by the IPTC Standards Committee on October 2nd, 2024.
The 2.1 and 1.5 versions of ninjs were approved by the IPTC Standards Committee
on May 17th, 2023.

This document focuses on the 3.0 version, but includes notes where the 2.x and
1.x versions differ. Those who must use version 2.x or 1.x for backwards
compatibility reasons can find the JSON Schema file for ninjs 2.1 at
https://iptc.org/std/ninjs/ninjs-schema_2.1.json and the schema file for ninjs 1.5
at https://iptc.org/std/ninjs/ninjs-schema_1.5.json.
...
Brendan Quinn (IPTC),
Michael Steidl (previous with IPTC),
...
These tables primarily describe the ninjs 3.0 schema. Where possible, we note
...
[source,json]
----
include::includes/examples/3.0/008_event.json[]
----
...
Suggested CV: http://cv.iptc.org/newscodes/eventstatus/ (which contains values such as "scheduled" and "cancelled")
|uri
...
NOTE: This section applies to dates in events and news coverage planning items in ninjs 3.0 only.
...
[source,json]
----
include::includes/examples/3.0/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/2.1/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/1.5/002_renditions_example.json[]
----
...
[source,json]
----
include::includes/examples/3.0/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/2.1/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/1.5/003_associations_example.json[]
----
...
[source,json]
----
include::includes/examples/3.0/004_simple_text_article.json[]
----
...
[source,json]
----
include::includes/examples/2.1/004_simple_text_article.json[]
----
...
[source,json]
----
include::includes/examples/1.5/004_simple_text_article.json[]
----
====
...
[source,json]
----
include::includes/examples/3.0/005_complex_text_article.json[]
----
...
[source,json]
----
include::includes/examples/2.1/005_complex_text_article.json[]
----
...
[source,json]
----
include::includes/examples/1.5/005_complex_text_article.json[]
----
====
...
[source,json]
----
include::includes/examples/3.0/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/2.1/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/1.5/006_photo_only.json[]
----
...
[source,json]
----
include::includes/examples/3.0/007_multimedia.json[]
----
...
[source,json]
----
include::includes/examples/2.1/007_multimedia.json[]
----
...
[source,json]
----
include::includes/examples/1.5/007_multimedia.json[]
----
...
|`uri`|`uri`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#identification-and-versioning[nar:newsItem@guid]
|`type`|`type`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#item-class-itemclass[nar:itemClass]
|`title`|title`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#item-title[nar:itemMeta/title]
|`altIds`|`altids`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#alternative-identifier-altid[nar:altId]
|`profile`|`profile`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#profile-profile[nar:profile]
|`version`|`version`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#identification-and-versioning[nar:newsItem@version]
|`firstCreated`|`firstcreated`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#date-first-created---firstcreated[nar:firstCreated]
|`versionCreated`|`versioncreated`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#date-version-created---versioncreated[nar:versionCreated]
|`expires`|`expires`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#expires[nar:expires]
|`embargoedUntil`|`embargoed`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#date-item-embargo-ends-embargoed[nar:embargoed]
|`pubStatus`|`pubstatus`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#publish-status-pubstatus[nar:pubStatus]
|`urgency`|`urgency`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#urgency-urgency[nar:urgency]
|`edNote`|`ednote`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#editorial-note[nar:edNote]
|`language`|`language`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#language-language[nar:language]
|`copyrightHolder`|`copyrightholder`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#rights-information[nar:copyrightHolder]
|`copyrightNotice`|`copyrightnotice`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#rights-information[nar:copyrightnotice]
|`usageTerms`|`usageterms`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#usage-terms-usageterms[nar:usageTerms]
|`rightsInfo`|`rightsinfo`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#rights-information[nar:rightsInfo]
|`headlines`|`headlines`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#headline-headline[nar:headline] with @role
|`headlines`/`contentType`|`headlines`/`contenttype`|nar:contentType
|`slugline`|`slugline`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#slugline-slugline[nar:slugline]
|`by`|`by`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#by---by[nar:by]
|`bodies`|`bodies`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#newsitem-content[nar:data or nar:inlineXML]
...
|`descriptions`|`descriptions`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#description-description[nar:description]
|`descriptions`/`contentType`|`descriptions`/`contenttype`|nar:contentType
|`located`|`located`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#located-located[nar:located]
|`genre`|`genre`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#genre-genre[nar:genre]
|`people`|`people`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#subject-subject[nar:subject]
|`organisations`|`organisations`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#subject-subject[nar:subject]
|`places`|`places`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#subject-subject[nar:subject]
|`subjects`|`subjects`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#subject-subject[nar:subject]
|`objects`|`objects`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#subject-subject[nar:subject]
|`infoSources`|`infosource`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#information-source-infosource[nar:infoSource]
|`trustIndicators`|`trustindicators`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#item-links[nar:link] with @rel
|`renditions`|`renditions`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#remote-content-remotecontent[nar:remoteContent]
...
|`associations`|`associations`|https://www.iptc.org/std/NewsML-G2/2.31/specification/NewsML-G2-2.31-specification.html#item-links[nar:link]
|===

    ...
    getninjsOutput(version) {
        ...
        if (version == "ninjs1x") {
            standard = {
                "name": "ninjs",
                "version": "1.7",
                "schema": "https://iptc.org/std/ninjs/ninjs-schema_1.7.json"
            };
            ...
            standard = {
                "name": "ninjs",
                "version": "2.3",
                "schema": "https://iptc.org/std/ninjs/ninjs-schema_2.3.json"
            };
            standardkey = 'standard';
                ...
                <div className="form-row">
                    ...
                    <div className="col-sm-8">
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" defaultChecked name="outputformat" id="ninjs3x" value="ninjs3x" title="Output format - ninjs 3.2" onChange={this.handleInputChange} tabIndex="23" />&nbsp;
                            <label className="form-check-label" htmlFor="ninjs3x">ninjs 3.2</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="outputformat" id="ninjs2x" value="ninjs2x" title="Output format - ninjs 2.3" onChange={this.handleInputChange} tabIndex="23" />&nbsp;
                            <label className="form-check-label" htmlFor="ninjs2x">ninjs 2.3</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="outputformat" id="ninjs1x" value="ninjs1x" title="Output format - ninjs 1.7" onChange={this.handleInputChange} tabIndex="24" />&nbsp;
                            <label className="form-check-label" htmlFor="ninjs1x">ninjs 1.7</label>
                        </div>
                    </div>
                </div>

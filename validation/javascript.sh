...
validate_folder_against_schema draft2020 'test_suite/3.1/should_pass' '../specification/ninjs-schema_3.1.json' valid
validate_folder_against_schema draft2020 'test_suite/3.0/should_pass' '../specification/ninjs-schema_3.1.json' valid
...
validate_folder_against_schema draft2020 'test_suite/3.1/should_fail' '../specification/ninjs-schema_3.1.json' invalid
validate_folder_against_schema draft2020 'test_suite/3.0/should_fail' '../specification/ninjs-schema_3.1.json' invalid
...
validate_folder_against_schema draft2020 'test_suite/2.1/should_pass' '../specification/ninjs-schema_2.2.json' valid
validate_folder_against_schema draft2020 '../examples/2.1' '../specification/ninjs-schema_2.2.json' valid

echo "The following examples should fail validation:"
validate_folder_against_schema draft2020 'test_suite/2.2/should_fail' '../specification/ninjs-schema_2.2.json' invalid
validate_folder_against_schema draft2020 'test_suite/2.1/should_fail' '../specification/ninjs-schema_2.2.json' invalid
...
echo "--- ninjs 1.6 tests ---"
echo
validate_folder_against_schema draft7 'test_suite/1.6/should_pass' '../specification/ninjs-schema_1.6.json' valid
validate_folder_against_schema draft7 'test_suite/1.5/should_pass' '../specification/ninjs-schema_1.6.json' valid
validate_folder_against_schema draft7 '../examples/1.5' '../specification/ninjs-schema_1.6.json' valid

echo "The following examples should fail validation:"
validate_folder_against_schema draft7 'test_suite/1.6/should_fail' '../specification/ninjs-schema_1.6.json' invalid
validate_folder_against_schema draft7 'test_suite/1.5/should_fail' '../specification/ninjs-schema_1.6.json' invalid
